...
#The Project Gutenberg EBook of Kopciuszek, by Jacob Grimm and Wilhelm Grimm
#http://www.gutenberg.org/files/28044/28044-h/28044-h.htm
#for Touch Typing Tutor
cinderella = [
[[1,1,1,1,1],#1
['Za górami, za lasami, a w każdym razie hen, na dalekim wschodzie, mieszkała na wsi zamożna wdowa, mająca dwie córki i pasierbicę Rózię. ' ,
'Córki nie były ładne, ale chciały się wszystkim podobać, więc zaniedbując gospodarstwo i pracę domową, cały czas spędzały tylko na strojeniu się przed lustrem i na różnych zabawach. ',
'Że zaś pannom tym nieustannie potrzebna była służąca do grzania rurek, do prania i prasowania drobiazgów, do czyszczenia bucików i sukien, przeto cały ciężar tej roboty zwalił się na Rózię, przyrodnią siostrę panien. ',
...
[[1,1,1,1,1],#2
['Od kopcia, jaki czernił jej buzię przez ciągłe przebywanie w kuchni, siostry przezwały ją Kopciuszkiem i nazwa ta tak się z nią zrosła, że nikt inaczej nie wołał na nią, jak: Kopciuszku daj, Kopciuszku zrób, Kopciuszku leć, Kopciuszku przynieś! ' ,
...
'Sposobność ta zdarzyła się właśnie wtedy, gdy monarcha nowego państwa, w którem się to działo, postanowił ożenić swojego syna.'
]],
[[1,1,1,1,1],#3
...
'Przy rozsyłaniu zaproszeń nie pominięto i macochy Rózi wraz z jej córkami. - Kopciuszkowi, serce się z żalu ścisnęło, gdy macocha oświadczyła, że zabierze z sobą tylko dwie córki do dworu, a Rózia w domu zostanie. ',
'Siostry wykpiły Kopciuszka i poprostu pojąć nie mogły takiej bezczelności z jej strony, ażeby taka służąca im dorównać chciała! Cóż było robić? Rózia zmartwiła się ale, jak zwykle, żale swoje stłumiła w sobie i pokorniutko zaczęła pomagać siostrom w przygotowaniach do balu. ',
...
[[1,1,1,1,1],#6
['Spojrzała wdzięcznym wzrokiem za ptaszkami, wyprawiła siostry z domu i macochę, siadła pod piecem, zamyśliła się i znużona pracą usnęła: śniła o balu, na który pójść jej nie pozwolono; ',
'Wtem zrywa się na równe nogi, bo przed jej okiem zabłysło coś złotem i srebrem, jakaś nieziemska postać stanęła pośrodku kuchni. ',
'Była to Baba-Dziwo, czarnoksiężniczka. Młoda i piękna, że oczu od niej trudno było oderwać, miała wspaniałą, złocistą gwiazdę nad czołem; ',
'całą jej postać otulał niebieski płaszcz srebrem tkany, a brylantami zdobne trzewiczki stopy jej stroiły. W ręce trzymała laskę czarnoksięską, którą dotknęła Kopciuszka. ',
...
'Sama wieszczka zawołała nawet: - Ach, jakaś ty piękna! ',
...
'Krasnolicy, patrząc na nią, bladł i rumienił się na przemian, tak wielce był wzruszony; na razie nie miał odwagi przybliżyć się do niej. ',
'Gdy się przemógł jednak, gdy ją poprosił do tańca i gdy pokręcił się z nią dookoła sali, już był tak rozkochany, że nic go od niej nie było w stanie oderwać. ',
'Zaraz jął się pytać skąd jest, z jakiego kraju pochodzi, ale Kopciuszek uśmiechnął się tylko, nie zdradzając ani jednem słowem swego pochodzenia. ',
...
[[1,1,1],#13
['Zdziwiona i ze złości prawie od zmysłów odchodząca macocha i siostry przyrodnie, musiały patrzeć bezsilnie, jak zabiedzony Kopciuszek, to nieszczęsne, wzgardzone przez nich dziewczę, wsiadła do karety i jak ją powieziono na ślub z królewiczem. ',
'Ślub ten odbył się niebawem, a młodzi małżonkowie byli najszczęśliwszymi na kuli ziemskiej. ',
'A to już koniec opowiadania Braci Grimm zatytułowanego Kopciuszek.'
]]]