...
dp['abc_flashcards_word_sequence'] = ['Аутобус', 'Банана', 'Виолина', 'Гитара', 'Делфин', 'Ђерам', 'Ексер', 'Жирафа',
...
"""
=========================================================================================
We have this for time in serbian, actually we do not decline numbers but nouns of hours and minutes we do. So, we have the next situation:

h1: 1                  — сат 		m1: 1 21 31 41 51                — минут
h2: 2 3 4              — сата		m2: 2-20 22-30 32-40 42-50 52-59 — минута
h3: 5 6 7 8 9 10 11 12 — сати
=========================================================================================
"""
...
def time2str(h, m):
    ...
    if m == 0:
        ...
        return "%s и два минута" % n2txt(h)
    elif m == 15:
        return "%s и петнаест" % n2txt(h)
    elif m == 22:
        return "%s и двадесет два" % n2txt(h)
    elif m == 30:
        return "пола %s" % n2txt(h)
    elif m == 38:
        return "двадесет два до %s" % n2txt(h)
    elif m == 45:
        return "петнаест до %s" % n2txt(h)
    elif m == 58:
        return "два минута до %s" % n2txt(h)
    elif m == 59:
