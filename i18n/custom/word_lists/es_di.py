...
di = [[27, 'así', 'con', 'del', 'dio', 'dos', 'día', 'fui', 'hoy', 'los', 'los', 'los', 'los', 'más', 'oro', 'oso', 'oír', 'por', 'que', 'sin', 'sin', 'sur', 'una', 'uno', 'uva', 'ver', 'ver', 'vez'], 
[49, 'algo', 'aquí', 'azul', 'bajo', 'boca', 'cada', 'cama', 'cero', 'clac', 'cuna', 'cuna', 'cuya', 'dijo', 'ella', 'flor', 'flor', 'gris', 'hace', 'lado', 'leer', 'mano', 'maíz', 'nada', 'nada', 'niño', 'ocho', 'oler', 'otro', 'otro', 'oído', 'para', 'paño', 'peso', 'pico', 'pide', 'piel', 'piso', 'rana', 'roca', 'rojo', 'ropa', 'seis', 'tira', 'todo', 'todo', 'tren', 'tubo', 'vete', 'vino'], 
[84, 'ahora', 'armas', 'bache', 'barco', 'bello', 'borde', 'botín', 'campo', 'carne', 'carta', 'caída', 'caída', 'ciego', 'clara', 'coche', 'comer', 'común', 'deber', 'entre', 'espía', 'floja', 'flota', 'forma', 'frase', 'fresa', 'fruta', 'fuego', 'garra', 'golpe', 'goteo', 'hecho', 'horas', 'igual', 'junto', 'justo', 'lavar', 'lento', 'línea', 'marca', 'marzo', 'media', 'mejor', 'mente', 'meses', 'miedo', 'miedo', 'migas', 'miles', 'mirar', 'mismo', 'nacer', 'norte', 'novio', 'nuevo', 'nuevo', 'nunca', 'padre', 'paseo', 'pecas', 'peces', 'pieza', 'plana', 'plano', 'poder', 'poema', 'punto', 'punto', 'regla', 'sabía', 'saltó', 'saltó', 'siglo', 'signo', 'sobre', 'sueño', 'tallo', 'tapar', 'temor', 'tengo', 'valor', 'veces', 'venir', 'vista', 'visto'], 
...
[48, 'acuerdo', 'agujero', 'alegría', 'apretar', 'armario', 'barrido', 'calamar', 'camilla', 'canción', 'cerebro', 'ciruela', 'consejo', 'cuidado', 'derrame', 'después', 'difícil', 'ejemplo', 'embargo', 'energía', 'espacio', 'excepto', 'hechizo', 'hombres', 'injerto', 'mezclar', 'muestra', 'nadando', 'negocio', 'nuestro', 'ocultar', 'orgullo', 'pequeño', 'piernas', 'pizarra', 'plantas', 'pájaros', 'párrafo', 'rebuzno', 'rejilla', 'repente', 'sangrar', 'sentido', 'sugirió', 'sílabas', 'todavía', 'trabajo', 'vestido', 'volante'], 
[46, 'adjetivo', 'cacarear', 'calabaza', 'caliente', 'comienzo', 'conjunto', 'continuo', 'cultivos', 'defender', 'desierto', 'detalles', 'entender', 'entonces', 'escisión', 'escuchar', 'estación', 'estirada', 'fábricas', 'garabato', 'gobierno', 'insectos', 'interior', 'ladrillo', 'largarse', 'linterna', 'mantener', 'merienda', 'millones', 'montañas', 'palabras', 'preparar', 'problema', 'profesor', 'programa', 'proteger', 'proyecto', 'príncipe', 'recordar', 'registro', 'retorcer', 'ronquido', 'silencio', 'soldados', 'símbolos', 'valiente', 'voluntad'], 
[30, 'alimentos', 'alimentos', 'argumento', 'arrebatar', 'brillante', 'brillante', 'cabriolas', 'compuesto', 'constante', 'corriente', 'cualquier', 'derribado', 'diferente', 'dirección', 'eléctrica', 'encuentra', 'garabatos', 'generales', 'habilidad', 'industria', 'moléculas', 'pendiente', 'preguntas', 'problemas', 'productos', 'rebajarse', 'respuesta', 'resultado', 'sentencia', 'subrayado'], 
[15, 'campesinos', 'desarrollo', 'determinar', 'diferencia', 'golondrina', 'incorrecto', 'lentamente', 'movimiento', 'necesarias', 'presidente', 'pronunciar', 'quemaduras', 'rociadores', 'sustancias', 'zapatillas']]
