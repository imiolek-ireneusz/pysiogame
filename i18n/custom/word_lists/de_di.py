...
di = [[22, 'auf', 'bat', 'Bär', 'die', 'für', 'gab', 'Ihr', 'Ihr', 'kam', 'Lkw', 'mit', 'nie', 'pro', 'Rot', 'sah', 'Tag', 'tot', 'tut', 'vor', 'was', 'weg', 'Zug'],
[42, 'aber', 'Acht', 'Auto', 'Bach', 'Bett', 'Bild', 'Bild', 'Blau', 'dann', 'Dorf', 'dort', 'Feld', 'ging', 'Hang', 'Haut', 'hell', 'Herd', 'hier', 'Idee', 'klar', 'Korn', 'Loch', 'mehr', 'Mund', 'muss', 'März', 'nach', 'noch', 'Obst', 'ohne', 'Rand', 'Raum', 'Rost', 'Satz', 'Sinn', 'Spur', 'Tuch', 'Vieh', 'wenn', 'Wert', 'Zahl', 'Zwei'],
[63, 'alles', 'außer', 'Bahre', 'Beine', 'Berge', 'beste', 'Blick', 'Blume', 'Bluse', 'Blüte', 'breit', 'Brett', 'damit', 'Essen', 'essen', 'etwas', 'Fisch', 'flach', 'Fleck', 'Flöte', 'Geist', 'glanz', 'glatt', 'Heute', 'hören', 'hören', 'innen', 'Jeder', 'jedes', 'jetzt', 'Junge', 'klack', 'Klaue', 'klein', 'Lager', 'lesen', 'Linie', 'Monat', 'mutig', 'neben', 'Prinz', 'Punkt', 'Reise', 'sagte', 'schön', 'Sechs', 'sehen', 'Seite', 'Spion', 'steil', 'Stich', 'Stolz', 'Stück', 'Tafel', 'Tropf', 'unser', 'Vater', 'Vögel', 'Wiege', 'Worte', 'Wüste', 'Zweig', 'Ärger'],
[69, 'Absatz', 'Andere', 'andere', 'anders', 'Anfang', 'Bauern', 'Beweis', 'bitten', 'Blumen', 'bluten', 'dessen', 'Drache', 'einmal', 'falsch', 'fangen', 'Flamme', 'Flotte', 'fragen', 'Frosch', 'Furcht', 'Furcht', 'Gehirn', 'gehört', 'Geruch', 'gleich', 'Grafik', 'großen', 'Großen', 'halten', 'Klippe', 'kommen', 'Krippe', 'Krümel', 'können', 'locker', 'Mantel', 'Metall', 'Muster', 'Männer', 'nichts', 'Nichts', 'Norden', 'rühren', 'Schiff', 'Schlaf', 'Schlag', 'Selbst', 'selbst', 'selten', 'Silben', 'Skizze', 'Sommer', 'Spruch', 'Statik', 'stetig', 'Stille', 'Streik', 'Stärke', 'suchen', 'Traube', 'triste', 'Waffen', 'Wandel', 'werden', 'wieder', 'winden', 'wusste', 'Zucker', 'zurück'],
[41, 'Antwort', 'Auslauf', 'Aussage', 'bleiben', 'brachte', 'Energie', 'Entwurf', 'Füllung', 'gackern', 'geboren', 'Gedicht', 'gefühlt', 'gemacht', 'gesehen', 'Gestalt', 'Gewicht', 'glauben', 'Klammer', 'knurren', 'langsam', 'langsam', 'mehrere', 'Methode', 'Nörgler', 'Pflaume', 'Schrank', 'Schroff', 'Schwamm', 'starren', 'Stengel', 'Strumpf', 'Stunden', 'Symbole', 'südlich', 'tänzeln', 'Vorhang', 'wachsen', 'waschen', 'wichtig', 'Zeichen', 'zeichen'],
[38, 'Adjektiv', 'Ausdruck', 'befindet', 'Beispiel', 'Bewegung', 'blättern', 'entdeckt', 'Erdbeere', 'Ergebnis', 'erinnern', 'erwarten', 'Fabriken', 'Flugzeug', 'geworden', 'grimmige', 'Handlung', 'Insekten', 'Kleidung', 'kriechen', 'Kulturen', 'manchmal', 'Moleküle', 'Pflanzen', 'Produkte', 'Programm', 'Richtung', 'schlanke', 'schreien', 'Schwalbe', 'schützen', 'Soldaten', 'Splitter', 'sprechen', 'Sprechen', 'tausende', 'Wahrheit', 'zusammen', 'zwischen'],
[33, 'angehoben', 'angezeigt', 'aufregend', 'behandeln', 'besonders', 'bestimmen', 'Bräutigam', 'Differenz', 'Erfahrung', 'Gekritzel', 'gemeinsam', 'gemütlich', 'gestreckt', 'Industrie', 'innerhalb', 'Kontrolle', 'Millionen', 'notwendig', 'Pantoffel', 'plötzlich', 'Präsident', 'Regierung', 'reichlich', 'schaukeln', 'schnappen', 'schrubben', 'schwierig', 'stationär', 'verderben', 'verlassen', 'verstehen', 'weiterhin', 'Zeichnung'],
[12, 'allgemeine', 'entwickelt', 'Feuerstein', 'Halskrause', 'Herrschaft', 'Schnarchen', 'Substanzen', 'Verbindung', 'vereinbart', 'verstopfen', 'vorsichtig', 'Wörterbuch']]
