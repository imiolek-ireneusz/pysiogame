...
class BuildExe:
    def __init__(self):
        # Name of starting .py
        self.script = "pysiogame.py"

        # Name of program
        self.project_name = "pysiogame_V106"
        ...
        self.copyright = "Copyright (c) 2012-2015 Ireneusz Imiolek"

        # Description
        self.project_description = "pySioGame - Educational Activity Pack"

        # Icon file (None will use pygame default icon)
        self.icon_file = os.path.join("res", "icon", "pysiogame.ico")
