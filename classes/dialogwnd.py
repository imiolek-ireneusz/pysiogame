...
class DialogWnd():
    def __init__(self, mainloop):
        ...
        self.img_pos = (40, 40)
        try:
            self.img = pygame.image.load(os.path.join('res', 'images', "dialog_bg.png")).convert()
        except:
            pass
    ...
    def update(self):
        ...
        self.sbg = pygame.Surface(
            (self.mainloop.layout.screen_w, self.mainloop.layout.screen_h))  # the size of your rect
        self.sbg.set_alpha(180)  # alpha level
        self.sbg.fill((255, 255, 255))  # this fills the entire surface
