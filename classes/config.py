...
class Config():
    ...
    def __init__(self):
        ...
        if self.fribidi_loaded:
            self.lang_titles = ["English", "American English", "Català", "Español", "Ελληνικά", "Français", "תירבע", "Italiano", "Polski", "Português", "Русский", "Suomalainen", "Українська", self.arabic, "Dansk", "Deutsch", "Nederlands", "Slovenčina", "Test Language"]
            self.all_lng = ["en_GB", "en_US", "ca", "es_ES", "el", "fr", "he", "it", "pl", "pt_PT", "ru", "fi", "uk", "ar", "da", "de", "nl", "sk", "te_ST"]
            self.ok_lng = ["en_GB", "en_US", "ca", "es_ES", "el", "fr", "he", "it", "pl", "pt_PT", "ru", "fi","uk"]
        else:
            self.lang_titles = ["English", "American English", "Català", "Español", "Ελληνικά", "Français","תירבע", "Italiano", "Polski", "Português", "Русский", "Suomalainen","Українська", "Dansk","Deutsch","Nederlands", "Slovenčina", "Test Language"]
            self.all_lng = ["en_GB", "en_US", "ca", "es_ES", "el", "fr", "he", "it", "pl", "pt_PT", "ru", "fi", "uk", "da", "de", "nl", "sk", "te_ST"]
            self.ok_lng = ["en_GB", "en_US", "ca", "es_ES", "el", "fr", "he", "it", "pl", "pt_PT", "ru", "fi", "uk"]
