        ...
        if self.badge_count > 0:
            ...
            for i in range(ln):
                ...
                if self.results[i][0] in self.mainloop.m.id2icon:
                    ...
                    if self.results[i][
                        1] not in self.mainloop.m.lang_customized_icons:  # len(self.mainloop.m.id2icon[self.results[i][0]]) == 14:
                    ...
                    self.board.add_unit(apos[i], y + 4, 3, 1, classes.board.Label, levtxt, color2, "", 1)
                    self.board.units[-1].font_color = (255, 75, 0)
                    # self.board.add_unit(apos[i]+1,y+4,3,1,classes.board.Label,"date",color2,"",0)
                    self.board.add_unit(apos[i] - 2, y + 5, 7, 1, classes.board.Label,
            ...
            self.board.add_unit(0, 2, data[0], 1, classes.board.Label, self.lang.d["Nothing here yet..."], color2, "",
                                0)
