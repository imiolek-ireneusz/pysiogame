...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):
        ...
        self.board.add_unit(0,6,data[0],1,classes.board.Label,self.lang.d["Check for newer version..."],color,"",4)
        self.board.add_unit(0,7,data[0],1,classes.board.Label,"http://sourceforge.net/projects/pysiogame/",color,"",4)
