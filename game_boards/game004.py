...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level = 1):
        ...
        for i in range(1,10):
            for j in range(1,10):
                if self.level.lvl == 1 and (i == num1 and j == num2): color=color0
                elif self.level.lvl == 1 and (j == num1 and i == num2): color=color2
                elif (i == num1 and j == num2) or (j == num1 and i == num2): color=color0
                elif i == num1 or j == num2: color=color1
                elif (self.level.lvl == 2 or self.level.lvl == 5) and (i == num2 or j == num1): color=color1
                else: color = color2
                mul = i*j
                unique.add(mul)
                caption = str(mul)
