            ...
            if tt[1] == 0:
                ...
                if self.lang.d["time_string_one_to"] != "":
                    ...
                    if self.lang.d["time_string_1_59_past_mh"] != "":
                        text_string = self.lang.d["time_string_1_59_past_mh"] % (
                        minutes, self.lang.d["hours_b"][h_index])
                    elif self.lang.d["time_string_1_59_past_hm"] != "":
                        text_string = self.lang.d["time_string_1_59_past_hm"] % (
                        self.lang.d["hours_b"][h_index], minutes)
            else:
                if self.lang.d["time_string_1_59_past_mh"] != "":
